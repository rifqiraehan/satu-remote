  ...
  return `
    ...
    <div class="grid grid-cols-2 gap-4 justify-items-center">
      ...
      <button onclick="showAddModal()"
        class="border-2 border-dashed border-[#1A434E] rounded-xl w-full h-32 flex flex-col items-center justify-center text-[#1A434E] text-sm font-medium hover:bg-gray-50 transition">
  ...
  return `
    <div id="modalAdd" class="hidden fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-3xl p-6 w-80 shadow-lg relative">
        ...
        <select id="templateSelect" class="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-green-500">
      ...
      <div class="bg-white rounded-3xl p-6 w-96 shadow-lg relative text-[#1A434E]">
        ...
        <div class="flex">
          <input id="newButtonInput" type="text" placeholder="Tambah tombol..."
            class="flex-grow border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500" />
...
function pageRemote() {
  const buttons = currentButtons.map(b => `
    <div class="bg-gray-100 rounded-xl py-3 text-[#1A434E] font-medium text-sm shadow-sm cursor-pointer hover:bg-gray-200">
      ${b}
    </div>
  `).join("");
    ...
    <div id="modalDetail" class="hidden fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-3xl p-6 w-80 shadow-lg relative">
        ...
        <input id="editDeviceName" type="text"
          class="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-green-500 text-[#1A434E]"
